          ...
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="text-center group h-full">
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2 h-full flex flex-col justify-center">
                  ...
                  <div className="text-3xl xl:text-4xl font-bold text-gray-900 mb-2">{stat.value}</div>
                  <div className="text-md xl:text-lg font-medium text-gray-700 mb-2">{stat.label}</div>
